        ...
        public void ExecutarCRUD()
        {
            ...
            while (true)
            {
                ...
                else if (opc == "1")
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine();
                    Console.SetCursorPosition(colunaDados - 17, linhaDados - 3);
                    foreach (var c in cotacoes) Console.WriteLine($"{c.Id} - Forn {c.FornecedorId} - Valor {c.Valor:C} - Prazo {c.PrazoDias}d - Justif. : {c.JustificativaEscolha}");
                ...
                else if (opc == "2")
                {
                    ...
                    Console.WriteLine();
                    Console.SetCursorPosition(0, linhaDados - 3);
